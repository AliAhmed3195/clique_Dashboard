(function ()
{
    ...
    /** @ngInject */
    function apiService($resource,$http,Clique)
    {
        /**
        ...
        var api = {};
        //$http.defaults.headers.common['Authorization']=Clique.getUserToken();
		
		//$http.defaults.headers.common['Access-Control-Allow-Origin']= "*";
		//$http.defaults.headers.common['DEV']= "Token 916d66d29bb27ebf9e9e150c4e1b225a735663b5";
		
		// DEBUG: Token 916d66d29bb27ebf9e9e150c4e1b225a735663b5
        // Base Url
        //api.baseUrl = 'http://localhost/slim/paysync/public/';
        
        //api.baseUrl = Clique.getApiUrl();
		api.baseUrl ="http://localhost/slim/paysync/public/";
        api.version = "";
       
        /*erp*/
        api.erp=$resource(api.baseUrl+api.version+'erp');
        api.erp.status=$resource(api.baseUrl+api.version+'erp/status');
        api.paymentmethods=$resource(api.baseUrl+api.version+'paymentmethods/');
        api.apps=$resource(api.baseUrl+api.version+'dashboard/apps');
        
        /*payment methods*/
        //api.paymentmethods=$resource('http://localhost/slim/paysync/public/v1/paymentmethods/');
        //api.paymentmethods=$resource('http://localhost/slim/paysync/public/v1/paymentmethods');
